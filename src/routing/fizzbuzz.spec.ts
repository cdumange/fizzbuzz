...
import { FizzBuzzErrors, FizzbuzzRequest, FizzbuzzResponse } from '../models/fizzbuzz'
...
describe('test fizzbuzz endpoint', () => {
    describe('post', () => {
        it('200', async () => {
            ...
            const mockFizz = (input: FizzbuzzRequest) :  Either<FizzbuzzResponse, FizzBuzzErrors> => {
                if (input === input){
